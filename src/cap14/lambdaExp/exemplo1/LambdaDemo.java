package cap14.lambdaExp.exemplo1;
...
class LambdaDemo {
    public static void main(String[] args) {
        ...
        // metodo getValue() de MyValue.
        myVal = () -> 98.6;     // Uma expressão lambda simples.

        // Chama getValue(), que é fornecido pela expressão
        // lambda atribuída anteriormente.
        ...
        // Uma expressão lambda deve ser compatível com o metodo definido pela
        // interface funcional. Logo, essas instruções não funcionarão:
